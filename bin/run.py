...
config['s3_gateway.wsgi.log.path'] = os.path.abspath(
    os.path.expanduser(config['s3_gateway.wsgi.log.path'])
)
config['s3_gateway.controller.datastore.path'] = os.path.abspath(
    os.path.expanduser(config['s3_gateway.controller.datastore.path'])
)
config['s3_gateway.util.s3.log.file.path'] = os.path.abspath(
    os.path.expanduser(config['s3_gateway.util.s3.log.file.path'])
)
